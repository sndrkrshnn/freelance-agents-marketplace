...
export default function RegisterPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Main Content */}
      <div className="nav-padding-top flex items-center justify-center min-h-screen">
        <div className="max-w-md w-full px-4">
          <div className="card">
            ...
            <form className="space-y-6">
              <div>
                <label className="block font-mono text-sm mb-2">FIRST_NAME</label>
                <input
                  type="text"
                  className="input"
                  placeholder="John"
              ...
              <div>
                <label className="block font-mono text-sm mb-2">LAST_NAME</label>
                <input
                  type="text"
                  className="input"
                  placeholder="Doe"
          ...
          <p className="text-center text-sm text-gray-500 mt-4">
            Coming Soon - Registration System
          </p>
        </div>
      </div>
    </div>
